...
## Generated on : Fri Nov 08 14:54:36 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sm_aileron_actuator_acc.mexw64
...
START_DIR                 = C:/Aircraft_project/work
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sm_aileron_actuator_acc.mexw64
...
SRCS = $(START_DIR)/slprj/accel/sm_aileron_actuator/sm_aileron_actuator_acc.cpp $(START_DIR)/slprj/accel/sm_aileron_actuator/rtGetInf.cpp $(START_DIR)/slprj/accel/sm_aileron_actuator/rt_nonfinite.cpp $(START_DIR)/slprj/accel/sm_aileron_actuator/sm_aileron_actuator_acc_data.cpp $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = sm_aileron_actuator_acc.obj rtGetInf.obj rt_nonfinite.obj sm_aileron_actuator_acc_data.obj c_mexapi_version.obj
...
sm_aileron_actuator_acc.obj : $(START_DIR)/slprj/accel/sm_aileron_actuator/sm_aileron_actuator_acc.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/accel/sm_aileron_actuator/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/accel/sm_aileron_actuator/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


sm_aileron_actuator_acc_data.obj : $(START_DIR)/slprj/accel/sm_aileron_actuator/sm_aileron_actuator_acc_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
