...
%pos     = [0 0 0; 50 0 -300; 150 0 -500]; % Inertial Positions (x,y,-z) row vector for each time
pos     = [0 0 0; 50 0 -300; 95 5 -365; 130 15 -400; 155 45 -435; 185 75 -440; 185 90 -450; 185 120 -450; 185 150 -450];
