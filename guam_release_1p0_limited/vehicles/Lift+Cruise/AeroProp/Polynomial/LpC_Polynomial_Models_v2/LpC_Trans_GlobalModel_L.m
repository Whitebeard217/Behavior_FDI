...
%   "GenGlobalModel_fixed0.m" on 02-Jan-2021 20:08:49
%
% INPUTS:
...
%
% CALLS:
%   LpC_Trans_R37t40_PCp2FI_SWR_cv  LpC_Trans_R37t45_PCp2FI_SWR_cv  LpC_Trans_R42t45_PCp2FI_SWR_cv  LpC_Trans_R42t25_PCp2FI_SWR_cv  LpC_Trans_R22t25_PCp2FI_SWR_cv  LpC_Trans_R22t30_PCp2FI_SWR_cv  LpC_Trans_R27t30_PCp2FI_SWR_cv  LpC_Trans_R27t35_PCp2FI_SWR_cv  LpC_Trans_R32t35_PCp2FI_SWR_cv  
%
% WRITTEN BY:
%   Benjamin M. Simmons
...
switch true
   case u<(1 + 1/(4))
      [C]=LpC_Trans_R37t40_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend=0; % no model blending is required
   case u>=(1 + 1/(4)) && u<(8 + 1/(-2))
      [C1]=LpC_Trans_R37t40_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R37t45_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
   ...
   case u>=(8 + 1/(-2)) && u<(14 + 1/(-4))
      [C1]=LpC_Trans_R37t45_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R42t45_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 14 + 1/(-4); % upper limit of modeling interval
      LowerBound = 8 + 1/(-2); % lower limit of modeling interval
   case u>=(14 + 1/(-4)) && u<(20)
      [C1]=LpC_Trans_R42t45_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R42t25_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 20; % upper limit of modeling interval
      LowerBound = 14 + 1/(-4); % lower limit of modeling interval
   case u>=(20) && u<(33 + 1/(-2))
      [C1]=LpC_Trans_R42t25_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R22t25_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 33 + 1/(-2); % upper limit of modeling interval
      LowerBound = 20; % lower limit of modeling interval
   case u>=(33 + 1/(-2)) && u<(45)
      [C1]=LpC_Trans_R22t25_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R22t30_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 45; % upper limit of modeling interval
      LowerBound = 33 + 1/(-2); % lower limit of modeling interval
   case u>=(45) && u<(58 + 1/(-2))
      [C1]=LpC_Trans_R22t30_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R27t30_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 58 + 1/(-2); % upper limit of modeling interval
      LowerBound = 45; % lower limit of modeling interval
   case u>=(58 + 1/(-2)) && u<(70)
      [C1]=LpC_Trans_R27t30_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R27t35_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 70; % upper limit of modeling interval
      LowerBound = 58 + 1/(-2); % lower limit of modeling interval
   case u>=(70) && u<(83 + 1/(-2))
      [C1]=LpC_Trans_R27t35_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      [C2]=LpC_Trans_R32t35_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend = 1; % model blending is required
      UpperBound = 83 + 1/(-2); % upper limit of modeling interval
      LowerBound = 70; % lower limit of modeling interval
   case u>=(83 + 1/(-2))
      [C]=LpC_Trans_R32t35_PCp2FI_SWR_cv(u,v,w,LA,RA,LE,RE,RUD,N1,N2,N3,N4,N5,N6,N7,N8,N9);
      Blend=0; % no model blending is required
end
