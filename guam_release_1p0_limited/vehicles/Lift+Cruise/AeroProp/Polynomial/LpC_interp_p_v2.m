...
%   January 04, 2021 - modified for v2 aerodynamic models, BMS
%   March 04, 2021 - added smooth blending between flight regimes, BMS
%
...
if u>=-5 && u<=45 && min([N1;N2;N3;N4;N5;N6;N7;N8])>=550 && N9==0
...
elseif u>=-5 && u<=95 && min([N1;N2;N3;N4;N5;N6;N7;N8])>=550 && N9>=750
    invalid_speed = false;invalid_prop_speed = false;
...
elseif u>45 && u<=95 && min([N1;N2;N3;N4;N5;N6;N7;N8])>=550 && N9>=0 && N9<750
    invalid_speed = false;invalid_prop_speed = false;
...
elseif u>=50 && u<=130 && max(abs([N1;N2;N3;N4;N5;N6;N7;N8]))==0 && N9>=550
    invalid_speed = false;invalid_prop_speed = false;
...
elseif u>=50 && u<=130 && max(abs([N1;N2;N3;N4;N5;N6;N7;N8]))==0 && N9==0
    invalid_speed = false;invalid_prop_speed = false;
...
% Blending between different flight regimes.
    ...
    if u>=-5 && u<=45 && min([N1;N2;N3;N4;N5;N6;N7;N8])>=550 && N9>0 && N9<750
    ...
    elseif u>=50 && u<=95 && max([N1;N2;N3;N4;N5;N6;N7;N8])>0
    ...
    % rotors at speeds between 50 to 95 kts)
        ...
        % Check factor limits - if model limits are exceeded hold the boundary value.
        u=check_fac_limits(u, 50, 95, 2.0);
        v=check_fac_limits(v, -10, 10, 2.0);
        w=check_fac_limits(w, -10, 10, 2.0);
        Beta=check_fac_limits(Beta, -6, 6, 2.0);
        Alpha=check_fac_limits(Alpha, 0, 12, 2.0);
    ...
    elseif u>=50 && u<=130 && min([N1;N2;N3;N4;N5;N6;N7;N8])==0 && N9>0 && N9<550
