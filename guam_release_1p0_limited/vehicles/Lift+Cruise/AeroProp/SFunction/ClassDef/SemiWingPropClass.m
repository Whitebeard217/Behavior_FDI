...
%        if obj.NP  > 0 
    ...
    function draw(obj, rho, V, cm_b)
        ...
        surf(x_v, y_v, z_v, L,'edgecolor','none');
        ...
        if obj.hasProp
          ...
          for ii = 1:obj.NP 
            ...
            surf(X_w,Y_w,Z_w,'facecolor','k','edgecolor','none','facealpha',alpha)
            mArrow3(tCenter, tCenter+tArrow,'color','red','stemWidth',0.0025);
          end
        end
