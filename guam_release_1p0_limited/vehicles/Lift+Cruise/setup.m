function Out = setup(SimIn, target, releaseMode)
  ...
  switch SimIn.fmType
    ...
    case 'Polynomial'
      ...
      % Lift+Cruise polynomial model version to use
%       pmodel_option='v2.0';% version 2.0 models (SWR with 95% confidence)
%       pmodel_option='v2.1-SWR'; % version 2.1 SWR model with 99.99% confidence
      pmodel_option='v2.1-MOF'; % version 2.1 MOF model with kappa=0.2

      % path for the available Lift+Cruise aerodynamic models
      pmodel_v2p0_path = 'AeroProp/Polynomial/LpC_Polynomial_Models_v2';
      pmodel_v2p1_swr_path = 'AeroProp/Polynomial/LpC_Polynomial_Models_v2p1/SWR_99p99c';
      ...
      switch pmodel_option
        case 'v2.0'
          addpath([SimIn.vehiclepath,pmodel_v2p0_path])
          rmpath([SimIn.vehiclepath,pmodel_v2p1_swr_path])
          rmpath([SimIn.vehiclepath,pmodel_v2p1_mof_path])
        case 'v2.1-SWR'
          addpath([SimIn.vehiclepath,pmodel_v2p1_swr_path])
          rmpath([SimIn.vehiclepath,pmodel_v2p0_path])
          rmpath([SimIn.vehiclepath,pmodel_v2p1_mof_path])
        case 'v2.1-MOF'
