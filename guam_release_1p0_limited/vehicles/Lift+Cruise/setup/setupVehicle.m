...
if (SimIn.fmType == ForceMomentEnum.Polynomial)
  %% override flag to disable Adaptive controller, until it's tuned for the polynomial model.
  SimIn.Control.Adaptive.AdaptOn = 0;
end
